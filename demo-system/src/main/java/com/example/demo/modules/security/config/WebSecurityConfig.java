...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                // 过滤请求
                .authorizeRequests()
                .antMatchers("/login/**", "/favicon.ico", "/js/**", "/css/**",
                        "/h2-console/**","/*.html", "/**/*.html",
                        "/**/update","/**/delete","/**/list","/**/add").anonymous()
...
//                .antMatchers("/sysUser/**").hasRole("ADMIN")
        ...
        // 添加JWT filter 用户名登录
        http
                .addFilterBefore(demoJwtAuthenticationTokenFilter, UsernamePasswordAuthenticationFilter.class);
